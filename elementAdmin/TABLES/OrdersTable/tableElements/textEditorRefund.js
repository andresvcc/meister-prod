...
const productToTable = ({ product, order }) => `
  ...
  <br />
  <p>We have proceeded to make a partial refund of chf ${product.currency} ${product.price}</p>
  <br />
  <p>this process can take from 1 to 3 weeks, depending on your bank.</p>
  <br />
`;
