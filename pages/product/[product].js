...
const SectionProduitPhoto = dynamic(() => import('@/elementsClient/Sections/ProductUnique/ProductUniquePhotos'), { loading: () => <Div style={{ width: '100%', height: '400px' }}> Loading ...</Div>, ssr: false });
