...
const mapArray = [
  { title: '1. General informasstion', description1: '1.1 Meister Engineering SA is a Swiss company registered at the Geneva Trade Registry under the reference n° CHE-460.815.918 and has its address at route d’Hermance 150A, 1245 Collonge-Bellerive, Geneva, Switzerland.', description2: '1.2 Meister Engineering SA sells goods and offers services in relation to motorcycles and related products.' },
  {
...
function Page(props) {
  ...
  return (
    <Div width="100%" style={{ minHeight: '600px', backgroundColor: '#fbf9f4' }} vertical="top">
      <Div height={['75px', '80px', '80px', '80px', '80px']} />
      {width < 400 ? <Div /> : <Div height="70px" />}

      <Div width="95%" style={{ fontSize: '28px', fontFamily: 'GorgiaBold', fontWeight: 'bold' }}>
        Terms of Service
      </Div>
      <Div width="95%" style={{ paddingTop: '15px' }}>
        <Div width="95%" horizontal="left">
          <Spam type="termsBigTitle">
            {`${"Meister Engineering's terms of service"}`}
          </Spam>
        </Div>
      </Div>
      {
