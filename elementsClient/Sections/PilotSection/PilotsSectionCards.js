    ...
    <Div>
      <div className="flexBoxcontainer">
        {productPilot.map((val, i) => (
          <div key={`${i + 1}`} className="flex-itemBx2">
            <ProductCard2 product={val} addToBag={(color, size, optionSelect1, optionSelect2, optionSelect3) => addToBag(val, color, size, optionSelect1, optionSelect2, optionSelect3)} alReadyInBag={(color, size, optionSelect1, optionSelect2, optionSelect3) => alReadyinToBag(val.id, color, size, optionSelect1, optionSelect2, optionSelect3)} />
          </div>
        ))}
      </div>
    </Div>
