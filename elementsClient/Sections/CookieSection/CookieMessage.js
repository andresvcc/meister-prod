...
const contenuTextSection = {
  ...
  description2: 'In turn, we use cookies to measure and obtain statistical data about the navigation of the users. You can configure and accept the use of cookies. You can read more information about our Cookie Policy.'
};
...
const TextSection = () => {
  ...
  return (
    <Div height={['240px', '280px', '180px', '150px', '150px']} horizontal="center" vertical="bottom" width="95%">
      <Div height="15px" />
      ...
      <Div width="95%" height={['120px', '120px', '150px', '150px', '150px']} vertical="top" horizontal="left">
        <Spam type="testTypo3">
