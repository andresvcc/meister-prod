...
const SocialButton = (props) => {
  ...
  return (
    <Button color="white" style={{ width: '100%', border: '1px solid #00000050', boxShadow: 'none' }} {...rest}>
...
export default function BagCardDialog(props) {
  ...
  if (profilInfo.registered) {
    return (
      <Div
        style={{
          padding: 0, margin: 0, fontSize: '18px', position: 'absolute', top: 12, right: '50px'
        }}
      >
        <Div
          onClick={handleClick}
              ...
              <GridContainer spacing={2}>
                ...
                <GridItem num={[12, 12, 12, 12, 12]}>
                  <Div width="90%" horizontal="left" style={{ fontFamily: 'GorgiaLight' }}>
                    <Div width="100%" horizontal="at" row vertical="top">
                      <Div>
                        My Account
                      </Div>
                      <Div
                        onClick={allClose}
                        style={{
                          color: 'grey', fontFamily: 'NovaLight', fontSize: '17px', position: 'fixed', top: 15, right: '45px'
                        }}
                      >
                        Close
                      </Div>
                ...
                <MenuList role="menu" style={{ width: '100%' }}>
                  {
                      notificationsKeys.map((val) => (
                        <MenuItem
                          ...
                          key={val}
                          style={{ width: '100%', padding: '10px 60px 10px 50px' }}
                        >
                          <Div
                            width="100%"
                            height="100%"
                            style={{
                              fontFamily: 'NovaLight, sans serif', fontSize: '15px', textTransform: 'capitalize', borderBottom: '1px solid grey'
                            }}
                          >
                            {val}
                          </Div>
